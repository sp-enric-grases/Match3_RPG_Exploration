...
Shader "socialPointCG/sCG_standard_terrainRoadsComposite_solid"
{
	Properties
	{
	...
	SubShader
	{
		...
		*/
		...
		void surf(Input IN, inout SurfaceOutputStandard o) 
		{
			...
			float VC_CM_mask = saturate(CM.g + IN.color.r);

			DF = lerp(DF, DF_grass, VC_CM_mask); 
			...
			fixed detail = lerp(detail_rock, detail_grass, VC_CM_mask);
			...
			// Normal
			float bumpScale = _BumpScale * (1.0 - snowMask * _BumpSmoothness) * (1.0 - VC_CM_mask);
