...
namespace SocialPoint.Tools
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        public void ChangeMusicWithFade(AudioClip clip, float fadeDuration, float finalVolume = 1)
        {
            this.newClip = clip;
            ChangeMusicWithFade(fadeDuration, finalVolume);
        }
        ...
        private void ChangeMusicWithFade(float fadeDuration, float finalVolume = 1)
        {
        ...
        private AudioClip GetAudioClipFromDatabase(string clip)
        {
            ...
            return audiosList.clip.Find(a => a.name == clip);
        }
